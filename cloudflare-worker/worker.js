...
async function createBuild(request, env) {
  ...
  const config = {
    versionCode: String(b.versionCode || 1),
    orientation: b.orientation || "portrait",
    splashEnabled: String(b.splashEnabled !== false && b.splashEnabled !== "false"),
    splashMs: String(b.splashMs || 2000),
    splashBgType: b.splashBgType === "gradient" ? "gradient" : "solid",
    splashBg: b.splashBg || "#0B1020",
    splashBg2: b.splashBg2 || "#4F46E5",
    splashText: b.splashText || "#FFFFFF",
    splashAccent: b.splashAccent || "#A78BFA",
    splashAlign: b.splashAlign || "center",
    splashLoading: b.splashLoading || "bar",
    splashAnimation: b.splashAnimation || "fade",
    splashTitle: b.splashTitle || b.appName || "My Website App",
    splashTagline: b.splashTagline || "",
    splashShowLogo: String(b.splashShowLogo !== false && b.splashShowLogo !== "false"),
    splashShowTitle: String(b.splashShowTitle !== false && b.splashShowTitle !== "false"),
    splashShowTagline: String(b.splashShowTagline === true || b.splashShowTagline === "true"),
    splashShowLoading: String(b.splashShowLoading !== false && b.splashShowLoading !== "false"),
    backNavigation: String(b.backNavigation !== false && b.backNavigation !== "false"),
    exitConfirm: String(b.exitConfirm !== false && b.exitConfirm !== "false"),
    internetCheck: String(b.internetCheck !== false && b.internetCheck !== "false"),
    fileUpload: String(b.fileUpload !== false && b.fileUpload !== "false"),
    fileDownload: String(b.fileDownload !== false && b.fileDownload !== "false"),
    pullToRefresh: String(b.pullToRefresh === true || b.pullToRefresh === "true"),
    externalLinks: String(b.externalLinks !== false && b.externalLinks !== "false"),
    zoomEnabled: String(b.zoomEnabled === true || b.zoomEnabled === "true"),
    keepScreenOn: String(b.keepScreenOn === true || b.keepScreenOn === "true"),
    preventScreenshots: String(b.preventScreenshots === true || b.preventScreenshots === "true"),
    cameraPermission: String(b.cameraPermission === true || b.cameraPermission === "true"),
    microphonePermission: String(b.microphonePermission === true || b.microphonePermission === "true"),
    locationPermission: String(b.locationPermission === true || b.locationPermission === "true"),
    iconUrl: b.iconUrl || "",
